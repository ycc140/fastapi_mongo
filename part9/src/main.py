...
# So you can se how to do your own logging and to
# test the handling of different log levels in Docker.
...
@app.get("/")
async def root_path():
    """ Return a welcome message when you visit the root URL. """
